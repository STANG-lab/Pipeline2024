...
and paste it to an existing entity_csv file 
sep each col by ;
when pasting, right click on cell [0,0], 
...
then manually checked each ne's context and make the replacement as meaningful as possible
then need to manually replace the first row's name csv
'''

#phi_path = root_data + 'Remora-2023//Batch-1//reports//deid_report//MASTER_PHI.csv'


def get_phi_dic(phi_path):  # path to MASTER_PHI.csv
