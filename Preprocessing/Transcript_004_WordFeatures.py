...
def get_word_features(out_dirs, text_target, word_level_csv="4_word_level_features.csv"):
    #This function sets the paths for the rest of the script.
    ...
    word_aggs = out_dirs["Features/word_aggregates"]
    ### Specify Destination folder
    # word_feature_location = "Remora-2023//Batch-1//4_word_level_features//"
    word_feature_csv_path = out_dirs["Features"] / word_level_csv
    word_feat_folder = out_dirs["Features/4_word_features"]
    get_word_feats(word_feature_csv_path, text_target, word_feat_folder, word_aggs)

def get_word_feats(word_feature_csv_path, text_target, word_feat_folder, word_aggs):
    ...
    all_aggregate_files = word_aggs.glob("*.csv")
    ...
    for aggregate in all_aggregate_files:
        ...
        for index, row in df2.iterrows():
            ...
            for each_token in tokens_text:
                ...
                # def check_keys(dic):
                #     if each_token in dic.keys(): # each_token defined from outer scope.
                #         return True
                #     else:
                #         return False
            ...
            try:
                ...
                pass
        df2.to_csv(word_feat_folder / Path(aggregate).name)
        #
    ...
    for aggregate in word_feat_folder.glob("*.csv"):
    ...
    report_df.to_csv(word_feature_csv_path)
